...
namespace GB_01_09FileManager
{
    public class MoveCursor
    {
        ...
        public int Top
        {
            ...
            set
            {
                if (0 <= value && value <= Console.WindowHeight - UI.PANEL_HEIGHT)
                {
                    this.top = value;
                }
                else
        ...
        public int Left
        {
            ...
            set
            {
                if (0 <= value && value <= Console.WindowWidth - UI.PANEL_WIDTH)
                {
                    this.left = value;
                }
                else
        ...
        private int height = UI.PANEL_HEIGHT;
        public int Height
        {
            get
            {
        ...
        private int width = UI.PANEL_WIDTH;
        public int Width
        {
            get
            {
